		...
		<div class="wrap">
			...
			<div style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap;">
				...
				<div style="flex: 1; min-width: 280px; max-width: 420px; background: #fff; border: 1px solid #ccd0d4; padding: 16px; box-sizing: border-box;">
					...
					<p><strong><?php esc_html_e( 'Plain text with before text', 'simplicity-weather' ); ?></strong><br /><code>[simplicity_weather location="edinburgh" fields="temp,condition" format="text" before="Currently: "]</code></p>
					...
					<p><strong><?php esc_html_e( 'AJAX badge with before text', 'simplicity-weather' ); ?></strong><br /><code>[simplicity_weather location="edinburgh" mode="ajax" fields="temp,condition" before="Currently: "]</code></p>
				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p><label for="simplicity-weather-badge-font-size"><?php esc_html_e( 'Font Size', 'simplicity-weather' ); ?></label><br /><input id="simplicity-weather-badge-font-size" class="regular-text" type="text" name="simplicity_weather_settings[badge_font_size]" value="<?php echo esc_attr( $settings['badge_font_size'] ); ?>" /></p>
